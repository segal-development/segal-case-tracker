"""Migration importability test for 027_add_decision_engine_to_cases.
...
_MIGRATION_PATH = (
    ...
    / "alembic/versions/027_add_decision_engine_to_cases.py"
)


def _load_migration():
    spec = importlib.util.spec_from_file_location(
        "migration_027", _MIGRATION_PATH
    )
...
class TestMigration027Importable:
    ...
    def test_down_revision_chains_to_026(self):
        mod = _load_migration()
